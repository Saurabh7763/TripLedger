...
import { googleSignup } from '../firebase/GoogleSingup'
    ...
    <SafeAreaView>
        <View style={tailwind`flex h-full justify-evenly `}>
            ...
            <View style={tailwind`mx-5`}>
                <Text style={tailwind`text-center text-4xl mb-10 font-bold ${colors.heading}`}>
                    TripLedger
                </Text>
                <TouchableOpacity
                 style={[tailwind`py-3 rounded-full mb-3 `,{backgroundColor:colors.button}]}
                ...
                />
                    <Text style={tailwind`text-lg font-bold ${colors.heading} text-center`}>
                        Sign Up with Google
                    </Text>
                </TouchableOpacity>
